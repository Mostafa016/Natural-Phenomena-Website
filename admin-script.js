function removeArticleSection(input) {
    document.getElementById('contentHolder').removeChild(input.parentNode);
  }
function addArticleSection(){
  var newArticle = document.createElement("section");
  newArticle.className = "section-of-content";
  newArticle.innerHTML = `
      <h2 class="content-header" contenteditable = "true">Title</h2>

      <button class = "deleteButton" onclick = "removeArticleSection(this)">Delete Article</button>

			<div class="pic">              
				<img src = "" class = "newPic">			
			</div>
     
			<p class="content" contenteditable = "true">
      Content goes here.
			</p>`;
      document.getElementById("contentHolder").appendChild(newArticle);
}
